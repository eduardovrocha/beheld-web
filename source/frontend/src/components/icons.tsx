/** Shared inline SVG icons (stroke = currentColor, herdam a cor do contexto). */

// Check-circle (feather) — selo de identidade verificada.
...
// Check (feather) — confirmação de cópia bem-sucedida.
