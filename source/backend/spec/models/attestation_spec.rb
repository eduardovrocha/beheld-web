...
RSpec.describe Attestation do
  ...
  describe ".build_payload" do
    ...
    it "monta payload com type, platform_key_id, dev_pubkey, github e attested_at" do
      ...
      expect(payload["type"]).to eq("beheld-identity-attestation/v1")
      expect(payload["platform_key_id"]).to eq("beheld-platform-2026-q2")
  ...
  describe ".fingerprint" do
    ...
    it "bate com o fingerprint registrado em keys/platform/beheld-platform-2026-q2.info.json" do
